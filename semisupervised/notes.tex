...
\begin{minipage}[b]{0.4\textwidth}\centering
  \input{simple-data/density_threshold}
\end{minipage}
\begin{minipage}[b]{0.4\textwidth}\centering
  \input{simple-data/semi_threshold}
\end{minipage}

\caption{Input space sorted by threshold functions.}
\end{table}
\end{comment}

As possible to see in \autoref{tab:simple-data-sorted} the access to unlabelled data allowed the system to better
