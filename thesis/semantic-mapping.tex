...
% In order to build such a mapping of the environment, it is important to define the knowledge that allows the agent to reason
% about. 
...
% Such a representation is by its nature imperfect, incomplete, inaccurate and invalid.
