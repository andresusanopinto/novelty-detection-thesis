...
Its with a final interest on integrated the developed methods on Dora that this
...
\begin{equation}
P_G(x) = \frac{1}{Z}\prod_{}{\phi(...)},\qquad Z = \sum\prod{\phi(...)}
\end{equation}
...
marginals on any given subset $x$ of variables by exploiting conditional
