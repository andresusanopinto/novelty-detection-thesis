...
optimal parameters given the current structure of the model which constantly changes. To this end, this work 
...
Based on this, it can be said that an optimal novelty detection system is aims at 
