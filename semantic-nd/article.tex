...
which already possesses a developed architecture based on proababilistic graphical models 
...
room categorization and novelty detection (Section~\ref{}). Then, we give an outline of the 
architecture of Dora and the structure of the conceptual map representing the semantic information
(Section~\ref{}). Next, we discuss the methods for novelty detection (Section~\ref{}) 
and present results of our prelimianary experiments (Section~\ref{}). This paper concludes with a 
summary in Section~\ref{}.
