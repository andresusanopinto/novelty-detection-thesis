...
\subfloat[3 sensed variables]{5 sensed variables}
\qquad
\subfloat[5 sensed variables]{5 sensed variables}

\subfloat[10 sensed variables]{10 sensed variables}
\qquad
\subfloat[50 sensed variables]{50 sensed variables}
...
\begin{itemize}
\item Show a correct estimation of unconditional probability to be important in establishing a novelty detection threshold
