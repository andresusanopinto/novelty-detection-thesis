...
in account.
In specific the point on this initial work was to test the correctness of the
presented threshold function and approximation capabilities by using an uniform or
independent model.
